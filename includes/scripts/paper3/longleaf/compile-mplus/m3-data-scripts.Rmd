...
# European snps.
# updated 5/17/2018: revised power calculations and smaller list of candidate snps
...
length(select.rsid) # 10 snps selected from lit
...
length(cn) # 10 snps in the slcs file -- 
as.character(cn)
